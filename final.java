...
public class FinalProjectTuesday {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		char goalHead = 'D'; // Final orientation the robot needs to reach (either 'U', 'D', 'L', 'R')
		boolean goal = false;
...
//				System.out.println("START LOOP");
	...
	public static boolean ifGoal(char curPos,char curHead, char goalPos,char goalHead) throws InterruptedException{
	...
	public static void turnHead(char curHead, int[] curCoord, int[] nextCoord) throws InterruptedException{
...
//		 System.out.println("turnHead running");
		 ...
		 switch (direction) {
			 case 1: case -3: System.out.println("turn 3");control.turn_90(); control.turn_90(); control.turn_90(); break;
			 case 2: case -2: System.out.println("turn 2");control.turn_90(); control.turn_90(); break;
			 case 3: case -1: System.out.println("turn 1");control.turn_90(); break;
			 default:  System.out.println("No turn"); break;
		 }
	}
